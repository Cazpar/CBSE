...
public class CollisionDetector implements IPostEntityProcessingService {
    ...
    public Boolean Collides(Entity entity, Entity entity2) {
        ...
        if (distance < (entity.getRadius() + entity2.getRadius())) {
            //Move the two entities away from eachother, so collision doesnt trigger multiple times instantly
            entMov.setX(entMov.getX()+100);
            entMov2.setX(entMov2.getX()-100);
            return true;
        }
        return false;
    }
